...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent) {
	...
	connect(backtest_screen, &BacktestWindow::toDoneScreen, this,
			[this] { stacked_widget->setCurrentWidget(done_screen); });
	...
	connect(select_strategy_screen, &SelectStrategyScreen::StartBacktestSwitch, this, [this] {
		...
		try {
			...
			connect(simulation_engine.get(), &SimulationEngine::progressUpdated, backtest_screen,
					&BacktestWindow::update_progress);
...
StartScreen* MainWindow::startScreen() const { return start_screen; }

DoneScreen* MainWindow::doneScreen() const { return done_screen; }

SelectStrategyScreen* MainWindow::selectStrategyScreen() const { return select_strategy_screen; }

CreateStrategyScreen* MainWindow::createStrategyScreen() const { return create_strategy_screen; }

QStackedWidget* MainWindow::stackedWidget() const { return stacked_widget; }
...
void MainWindow::stopCurrentSimulation() {
	...
	disconnect(backtest_screen, &BacktestWindow::pauseToggled, simulation_engine.get(),
			   &SimulationEngine::setPaused);
